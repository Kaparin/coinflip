  ...
  const renderPendingCard = (bet: PendingBet) => (
    ...
    >
      <div className="flex items-center justify-between mb-2">
        <span className="flex items-center gap-1.5 text-base font-bold tabular-nums">{formatLaunch(bet.amount)} <GameTokenIcon size={18} /></span>
      ...
      >
        <div className="flex items-center justify-between mb-1">
          <span className="flex items-center gap-1.5 text-base font-bold tabular-nums">
            {formatLaunch(bet.amount)} <GameTokenIcon size={18} />
          </span>
