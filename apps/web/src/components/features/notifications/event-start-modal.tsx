    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain">
            ...
            <div className="flex items-stretch gap-2">
              ...
              <div className={`flex-1 rounded-xl border ${borderColor} bg-[var(--color-bg)] p-3 text-center`}>
                ...
                <div className="flex items-center justify-center gap-1.5">
                  ...
                  {sponsorAddress ? <GameTokenIcon size={14} /> : <AxmTokenIcon size={14} />}
                </div>
              </div>
          ...
          {/* Sticky buttons */}
          <div className="sticky bottom-0 px-4 sm:px-5 pb-4 sm:pb-5 pt-2 bg-gradient-to-t from-[var(--color-surface)] via-[var(--color-surface)] to-transparent space-y-2">
            <button
              type="button"
