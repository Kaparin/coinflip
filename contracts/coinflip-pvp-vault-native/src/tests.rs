use cosmwasm_std::{coins, Uint128, Binary};
...
fn test_deposit_wrong_denom_rejected() {
    ...
    let info = cosmwasm_std::testing::mock_info(MAKER, &coins(100, "wrongdenom"));
    ...
    match err {
        ...
        _ => panic!("Expected PaymentError, got {:?}", err),
    }
}

#[test]
fn test_deposit_no_funds_rejected() {
    let (mut deps, env) = setup_contract();
...
fn test_withdraw_success() {
    ...
    // Should have a BankMsg::Send submessage
