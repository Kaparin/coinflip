...
export const UserProfileResponseSchema = z
  .object({
    ...
    stats: z.object({
      ...
      total_wagered: AmountSchema.openapi({ description: 'Total LAUNCH wagered', example: '5000' }),
      total_won: AmountSchema.openapi({ description: 'Total LAUNCH won', example: '3200' }),
    }),
